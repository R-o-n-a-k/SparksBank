...
<body>
  ...
  <div class="cont">
    <form action="">
      <br>
      <button id="vcustomer" class="btn btn-dark btn-lg btn-block " name="View Customer" value="View Customer"
        formaction="customer.php">View Customers</button><br>
      <button id="vhistory" class="btn btn-dark btn-lg btn-block " name="Transaction History"
